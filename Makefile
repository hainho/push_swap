...
OBJS=quick_main.o deque.o ft_atoi.o node.o parsing.o push.o pushswap.o reverseRotate.o rotate.o swap.o hardSort.o ft_split.o ft_substr.o ft_strdup.o ft_strlcpy.o ft_strlen.o ft_calloc.o ft_bzero.o ft_memset.o ft_memcpy.o freeStruct.o quick.o
